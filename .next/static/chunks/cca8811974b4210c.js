(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,19605,e=>{"use strict";var a=e.i(43476),i=e.i(71645);e.s(["default",0,({label:e,value:r,icon:l,suffix:t=""})=>{let[n,s]=(0,i.useState)(0);return(0,i.useEffect)(()=>{let e=0,a=parseInt(r)||0;if(e===a)return;let i=Math.ceil(a/100),l=setInterval(()=>{(e+=i)>=a?(s(a),clearInterval(l)):s(e)},20);return()=>clearInterval(l)},[r]),(0,a.jsxs)("div",{className:"galaxy-stat",children:[l&&(0,a.jsx)("div",{className:"galaxy-stat-icon",children:(0,a.jsx)(l,{size:20,strokeWidth:2.5})}),(0,a.jsxs)("div",{className:"galaxy-stat-value",children:["number"==typeof r?n:r,t]}),(0,a.jsx)("div",{className:"galaxy-stat-label",children:e})]})}])},5665,e=>{"use strict";var a=e.i(43476),i=e.i(71645);let r=({children:e,onClick:r,variant:l="primary",className:t="",type:n="button",disabled:s=!1})=>{let[c,m]=(0,i.useState)([]),[o,x]=(0,i.useState)({x:0,y:0}),u=(0,i.useRef)(null);return(0,a.jsxs)("button",{ref:u,type:n,onMouseMove:e=>{if(!u.current||s)return;let a=u.current.getBoundingClientRect(),i=a.left+a.width/2,r=a.top+a.height/2;100>Math.hypot(e.clientX-i,e.clientY-r)?x({x:(e.clientX-i)*.2,y:(e.clientY-r)*.2}):x({x:0,y:0})},onMouseLeave:()=>{x({x:0,y:0})},onClick:e=>{let a=e.currentTarget.getBoundingClientRect(),i=Math.max(a.width,a.height),l=e.clientX-a.left-i/2,t=e.clientY-a.top-i/2,n={id:Date.now(),x:l,y:t,size:i};m([...c,n]),setTimeout(()=>{m(e=>e.filter(e=>e.id!==n.id))},600),r&&r(e)},disabled:s,className:`uiverse-button ${l} ${t}`,style:{transform:`translate3d(${o.x}px, ${o.y}px, 0)`,transition:0===o.x?"transform 0.5s cubic-bezier(0.23, 1, 0.32, 1)":"none"},children:[(0,a.jsx)("span",{className:"ripples",children:c.map(e=>(0,a.jsx)("span",{className:"ripple",style:{left:e.x,top:e.y,width:e.size,height:e.size}},e.id))}),(0,a.jsx)("span",{className:"button-content",children:e})]})};e.s(["default",0,e=>(0,a.jsx)(r,{...e})],5665)},40322,e=>{"use strict";var a=e.i(43476),i=e.i(71645);let r=({children:e,className:r="",onClick:l})=>{let t=(0,i.useRef)(null);return(0,a.jsx)("div",{ref:t,className:`uiverse-card-container ${r}`,onClick:l,onMouseMove:e=>{if(!t.current)return;let a=t.current.getBoundingClientRect(),i=e.clientX-a.left,r=e.clientY-a.top,l=a.width/2,n=a.height/2;t.current.style.setProperty("--mouse-x",`${i}px`),t.current.style.setProperty("--mouse-y",`${r}px`),t.current.style.setProperty("--rotate-x",(n-r)/15),t.current.style.setProperty("--rotate-y",(i-l)/15)},onMouseLeave:()=>{t.current&&(t.current.style.setProperty("--rotate-x",0),t.current.style.setProperty("--rotate-y",0))},children:(0,a.jsxs)("div",{className:"uiverse-card",children:[(0,a.jsx)("div",{className:"card-shine"}),(0,a.jsx)("div",{className:"card-content",children:e})]})})};e.s(["default",0,({children:e,className:i="",title:l,subtitle:t,emoji:n,onClick:s,gradient:c})=>(0,a.jsxs)(r,{className:i,onClick:s,children:[(l||t||n)&&(0,a.jsxs)("div",{className:"flex flex-col items-center mb-4 text-center",children:[n&&(0,a.jsx)("div",{className:"text-4xl mb-2",children:n}),l&&(0,a.jsx)("h3",{className:"text-xl font-bold text-neutral-900 mb-1",children:l}),t&&(0,a.jsx)("p",{className:"text-sm text-neutral-500 opacity-80",children:t})]}),e]})],40322)},24771,27961,e=>{"use strict";var a=e.i(43476);e.i(71645),e.s(["default",0,({children:e,className:i=""})=>(0,a.jsx)("div",{className:`galaxy-container ${i}`,children:e})],24771),e.s(["default",0,({children:e,cols:i=3,className:r=""})=>(0,a.jsx)("div",{className:`galaxy-grid cols-${i} ${r}`,children:e})],27961)},11187,e=>{"use strict";var a=e.i(53458);let i=`Sen OMNIVERSAL ANLATI TEKİLLİK MERKEZİ'sin (OMNIVERSAL NARRATIVE SINGULARITY CORE).
...
Sadece JSON yazın.`,t=`Siz etkileşimli bir başkalaşım tasarımcısısınız. Kullanıcının deneyimini 3 seviyeli bir "İ\xe7sel G\xfc\xe7 Labirenti" oyununa d\xf6n\xfcşt\xfcr\xfcyorsunuz.
...
Sadece JSON yazın.`,n=`Siz yaratıcı bir isimlendirme uzmanısınız. Verilen hikaye veya oyun i\xe7eriğine ve bağlamına uygun, "KOZA" evrenine yakışır şekilde metaforik, kısa ve etkileyici bir başlık oluşturun.
...
Bağlam/İ\xe7erik: `,s=new Map,c=e=>{try{let a=e.replace(/```json/g,"").replace(/```/g,"").trim(),i=a.indexOf("["),r=a.indexOf("{"),l=-1,t=-1;return -1!==i&&(-1===r||i<r)?(l=i,t=a.lastIndexOf("]")):-1!==r&&(l=r,t=a.lastIndexOf("}")),-1!==l&&-1!==t&&(a=a.substring(l,t+1)),a}catch{return e}},m=e=>new Promise(a=>setTimeout(a,e)),o=async(e,r,l=3)=>{let t,n=a.API_CONFIG.OPENROUTER_API_KEY,o=window.location.origin,x=`${e.substring(0,50)}_${r.substring(0,100)}`,u=s.get(x);if(u&&Date.now()-u.timestamp<3e5)return console.log("📦 Using cached response"),u.data;for(let a=0;a<l;a++)try{let a=await fetch("https://openrouter.ai/api/v1/chat/completions",{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${n}`,"HTTP-Referer":o,"X-Title":"KOZA App"},body:JSON.stringify({model:"google/gemma-3-27b-it",messages:[{role:"system",content:i},{role:"user",content:`${e}

User experience: ${r}`}],temperature:.8,max_tokens:8192,response_format:{type:"json_object"}})});if(!a.ok){let e=await a.text();throw Error(`API error ${a.status}: ${e}`)}let l=(await a.json()).choices[0].message.content,t=JSON.parse(c(l));return s.set(x,{data:t,timestamp:Date.now()}),t}catch(e){if(t=e,console.error(`Attempt ${a+1} failed:`,e.message),a<l-1){let e=Math.min(1e3*Math.pow(2,a),5e3);console.log(`Retrying in ${e}ms...`),await m(e)}}throw Error(`Failed after ${l} attempts: ${t.message}`)},x=async e=>{if(!e||e.trim().length<10)throw Error("Lütfen deneyiminizi açıklayan en az 10 karakter girin");return o(r,e)},u=async(e,a)=>{if(!a||a.trim().length<5)throw Error("Lütfen daha detaylı bir geri bildirim sağlayın (en az 5 karakter)");return o(l.replace("{{EXISTING_STORY}}",JSON.stringify(e)).replace("{{USER_FEEDBACK}}",a),a)},d=async e=>{if(!e||e.trim().length<10)throw Error("Lütfen deneyiminizi açıklayan en az 10 karakter girin");return o(t,e)},k=async e=>{try{let a=n+`

Sadece şu JSON formatında yanıt verin: { "title": "Oluşturulan Başlık" }`;return(await o(a,e)).title}catch{return console.error("İsimlendirme başarısız"),"Dönüşüm Hikayesi"}};setInterval(()=>{let e=Date.now();for(let[a,i]of s.entries())e-i.timestamp>3e5&&s.delete(a)},3e5),e.s(["generateContentName",0,k,"generateGame",0,d,"generateStorybook",0,x,"refineStorybook",0,u],11187)},80763,54766,e=>{"use strict";let a=["self harm","suicide","want to die","kill myself","stab","with gun","hang myself","poison","kill someone","want to hurt","kendime zarar","intihar","ölmek istiyorum","kendimi öldürmek","bıçaklamak","silahla","kendimi asmak","zehir","birini öldürmek","zarar vermek istiyorum"],i=e=>{if(!e||"string"!=typeof e)return{isCrisis:!1};let i=e.toLowerCase().trim();return a.filter(e=>i.includes(e)).length>0?{isCrisis:!0,message:"Bu platform eğitim amaçlıdır. Kendiniz veya başkaları için tehlikede hissediyorsanız, lütfen hemen profesyonel yardım alın veya acil servisleri (örn. 112) arayın."}:{isCrisis:!1}};e.s(["SAFETY_DISCLAIMER",0,"KOZA eğitim amaçlı bir araçtır ve profesyonel psikolojik desteğin yerini tutmaz.","detectCrisis",0,i],54766);var r=e.i(11187);let l=e=>{let a=[];if(!e||"string"!=typeof e)return a.push("Geçerli bir metin girmelisiniz"),{isValid:!1,errors:a};let i=e.trim();return i.length<10&&a.push("Lütfen en az 10 karakter girin"),i.length>5e3&&a.push("Metin çok uzun (maksimum 5000 karakter)"),{isValid:0===a.length,errors:a,sanitized:i}},t=new Map,n=new Map,s={STATES:{IDLE:"IDLE",VALIDATING:"VALIDATING",SAFETY_CHECK:"SAFETY_CHECK",AI_COORDINATION:"AI_COORDINATION",MAPPING:"MAPPING",COMPLETED:"COMPLETED",FAILED:"FAILED"},resolveMetadata:(e,a,i)=>({type:e,title:a||("story"===e?"Dönüşüm Hikayesi":"Dönüşüm Oyunu"),userInput:i,reflectionQuestion:"Bu hikaye sana kendi gücün hakkında ne söylüyor?",growthLesson:"Zorluklar gelişimin habercisidir.",createdAt:new Date().toISOString()}),processNarrativeRequest:async(e,a="story")=>{let c=`${a}:${e.trim().toLowerCase()}`;if(n.has(c))return console.log("🚀 Optimization: Serving from Narrative Cache for:",c),n.get(c);if(t.has(c))return console.warn("⚡ Optimization: Deduplicating concurrent request for:",c),t.get(c);let m=(async()=>{try{let t=l(e);if(!t.isValid)throw Error(t.errors[0]);let m=i(t.sanitized);if(m.isCrisis)return{isSafetyTriggered:!0,message:m.message,redirect:"SAFETY_RESOURCES"};let[o,x]=await Promise.all(["story"===a?(0,r.generateStorybook)(t.sanitized):(0,r.generateGame)(t.sanitized),(0,r.generateContentName)(t.sanitized)]),u={isSafetyTriggered:!1,data:{...s.resolveMetadata(a,x,t.sanitized),pages:"story"===a?o.pages:void 0,levels:"game"===a?o.levels:void 0,themeColor:o.themeColor||"#9333EA",visualMood:o.visualMood||"Magical Shimmer"}};if(n.size>=50){let e=n.keys().next().value;n.delete(e)}return n.set(c,u),u}catch(e){throw console.error("Anlatı Katmanı Hatası:",e),Error(`Optimizasyon Katmanı Hatası: ${e.message}`)}finally{t.delete(c)}})();return t.set(c,m),m},processRefinementRequest:async(a,r)=>{let n=`refine:${a.id}:${r.trim().toLowerCase()}`;if(t.has(n))return t.get(n);let c=(async()=>{try{let t=l(r);if(!t.isValid)throw Error(t.errors[0]);let n=i(t.sanitized);if(n.isCrisis)return{isSafetyTriggered:!0,message:n.message};let[c,m]=await Promise.all([e.A(1110).then(e=>e.refineStorybook(a,t.sanitized)),e.A(1110).then(e=>e.generateContentName(t.sanitized))]);return{isSafetyTriggered:!1,data:{id:a.id,...s.resolveMetadata("story",m,a.userInput+" | Refinement: "+t.sanitized),pages:c.pages,themeColor:c.themeColor||a.themeColor,visualMood:c.visualMood||a.visualMood,refinedAt:new Date().toISOString()}}}catch(e){throw console.error("Düzenleme Katmanı Hatası:",e),Error(`Hikaye d\xfczenleme hatası: ${e.message}`)}finally{t.delete(n)}})();return t.set(n,c),c}};e.s(["NarrativeDomain",0,s],80763)},75400,e=>{"use strict";var a=e.i(43476),i=e.i(71645),r=e.i(60880),l=e.i(4839),t=e.i(25487),n=e.i(83494),s=e.i(80763),c=e.i(54766),m=e.i(83086),o=e.i(10980),x=e.i(92163),u=e.i(39312);let d=(0,e.i(75254).default)("chart-column",[["path",{d:"M3 3v16a2 2 0 0 0 2 2h16",key:"c24i48"}],["path",{d:"M18 17V9",key:"2bz60n"}],["path",{d:"M13 17V5",key:"1frdt8"}],["path",{d:"M8 17v-3",key:"17ska0"}]]);var k=e.i(24771);let y=({tabs:e=[],activeTab:r,onChange:l,className:t=""})=>{let[n,s]=(0,i.useState)({left:0,width:0}),c=(0,i.useRef)([]);return(0,i.useEffect)(()=>{let a=e.findIndex(e=>e.id===r);if(-1!==a&&c.current[a]){let e=c.current[a];s({left:e.offsetLeft,width:e.offsetWidth})}},[r,e]),(0,a.jsxs)("div",{className:`galaxy-tabs ${t}`,children:[(0,a.jsx)("div",{className:"galaxy-tab-indicator",style:{transform:`translateX(${n.left-6}px)`,width:n.width}}),e.map((e,i)=>(0,a.jsxs)("div",{ref:e=>c.current[i]=e,className:`galaxy-tab ${r===e.id?"active":""}`,onClick:()=>l(e.id),children:[e.icon&&(0,a.jsx)(e.icon,{size:16}),e.label]},e.id))]})},f=({label:e,value:i,onChange:r,placeholder:l,disabled:t,rows:n=4})=>(0,a.jsxs)("div",{className:"galaxy-textarea-container",children:[(0,a.jsx)("textarea",{className:"galaxy-textarea",value:i,onChange:e=>r(e.target.value),placeholder:l,disabled:t,rows:n}),e&&(0,a.jsx)("label",{className:"galaxy-textarea-label",children:e})]});var g=e.i(5665),h=e.i(52571),A=e.i(69638),v=e.i(78894),E=e.i(63209);let S={info:h.Info,success:A.CheckCircle,warning:v.AlertTriangle,error:E.AlertCircle},p=({type:e="info",title:i,children:r})=>{let l=S[e]||S.info;return(0,a.jsxs)("div",{className:`galaxy-alert ${e}`,children:[(0,a.jsx)(l,{className:"galaxy-alert-icon",size:20,strokeWidth:2}),(0,a.jsxs)("div",{className:"galaxy-alert-content",children:[i&&(0,a.jsx)("h4",{className:"galaxy-alert-title",children:i}),(0,a.jsx)("div",{className:"galaxy-alert-message",children:r})]})]})};var K=e.i(40322),b=e.i(27961),M=e.i(19605),T=e.i(31356);let N=(0,i.memo)(()=>(0,a.jsxs)("div",{className:"text-center mb-16 px-4",children:[(0,a.jsxs)("div",{className:"galaxy-badge primary mb-6 group cursor-default border-neutral-800 bg-neutral-900/50 text-neutral-300",children:[(0,a.jsx)(u.Zap,{size:14,className:"text-amber-500"}),(0,a.jsx)("span",{children:"Sovereign Cognitive Auditing"})]}),(0,a.jsx)("h1",{className:"text-6xl font-black mb-4 tracking-tight uppercase text-neutral-900",children:"Deneyimi Yapılandır"}),(0,a.jsx)("p",{className:"text-neutral-500 text-lg font-medium max-w-xl mx-auto leading-relaxed border-l-2 border-neutral-200 pl-6 text-left",children:"Karmaşık anlatıları eyleme geçirilebilir sinyallere dönüştürün. Karmaşayı en aza indirin."})]})),z=(0,i.memo)(({user:e})=>{var i;let r=(i=e,Math.min(Math.round(2*(i?.storiesCreated||0)+(i?.xp||0)/1e3),99.9));return(0,a.jsx)("div",{className:"mt-20 border-t border-neutral-200 pt-12",children:(0,a.jsxs)(b.default,{cols:3,children:[(0,a.jsx)(M.default,{icon:o.BookOpen,label:"Yapılandırılmış Anlatılar",value:e?.storiesCreated||0}),(0,a.jsx)(M.default,{icon:u.Zap,label:"Netlik Endeksi",value:e?.xp||0}),(0,a.jsx)(M.default,{icon:d,label:"Azaltılmış Karmaşa",value:`${r}%`})]})})}),R=(0,i.memo)(()=>{let{user:e,awardXP:u}=(0,r.useUser)(),{activeStory:d,setActiveStory:h,isProcessing:A,setIsProcessing:v,analysisResult:E,setAnalysisResult:S,saveStory:b}=(0,l.useStory)(),{setCurrentView:M,addToast:R}=(0,t.useUI)(),{isAdmin:L}=(0,n.useAuth)(),[D,O]=(0,i.useState)(""),[I,G]=(0,i.useState)(null),[j,C]=(0,i.useState)("story"),Y=(0,i.useCallback)(async()=>{if(d.trim()&&!A){G(null),v(!0),O("Anlatı vektörleri çözümleniyor...");try{var e,a;let i=await s.NarrativeDomain.processNarrativeRequest(d,j);if(i.isSafetyTriggered){G(i.message),L&&R("warning","Safety Warning","Your input was flagged by our safety filters.");return}let{data:r}=i;S({type:j,category:r.title,data:r}),b(r);let l=(e=d,a=r,Math.min(Math.floor(e.length/50),50)+(a?.actionPoints?.length?10*a.actionPoints.length:20)+50);u(l,"story"===j?"Anlatı yapılandırıldı":"Mantık simülasyonu oluşturuldu"),R("success","Netlik Arttı",`+${l} Netlik Endeksi`)}catch(e){console.error("Generation failed:",e),G(e.message||"An error occurred. Please try again."),L&&R("error","Error",e.message||"Creation failed")}finally{v(!1),O("")}}},[d,j,A,L,v,S,b,u,R]),B=(0,i.useCallback)(()=>{E&&(M({type:E.type,data:E.data}),h(""),S(null))},[E,M,h,S]);return(0,a.jsxs)(k.default,{className:"py-8",children:[(0,a.jsx)(N,{}),(0,a.jsx)("div",{className:"max-w-2xl mx-auto",children:E?(0,a.jsxs)(K.default,{className:"text-center",title:E.category,subtitle:"story"===E.type?"Hikaye Hazır":"Oyun Hazır",emoji:"story"===E.type?"📖":"🎮",children:[(0,a.jsx)("p",{className:"text-neutral-500 text-lg mb-10",children:"story"===E.type?"Deneyiminiz artık moral verici bir hikaye.":"Zorluğunuz artık heyecan verici bir oyun."}),(0,a.jsxs)("div",{className:"flex flex-col sm:flex-row gap-4 justify-center",children:[(0,a.jsx)(g.default,{onClick:B,children:"story"===E.type?"Hikayeyi Oku":"Oyunu Oyna"}),(0,a.jsx)(g.default,{onClick:()=>{S(null),h("")},variant:"secondary",children:"Yeni Vektör İşle"})]})]}):(0,a.jsxs)("div",{className:"space-y-8",children:[(0,a.jsx)("div",{className:"flex justify-center",children:(0,a.jsx)(y,{activeTab:j,onChange:C,tabs:[{id:"story",label:"Yapısal Denetim",icon:o.BookOpen},{id:"game",label:"Mantık Simülasyonu",icon:x.Gamepad2}]})}),(0,a.jsxs)("div",{className:"animate-slide-up",children:[(0,a.jsx)(f,{value:d,onChange:h,placeholder:"story"===j?"Yapısal çözümleme için ham anlatı verilerini girin...":"Mantık simülasyonu için bilişsel zorlukları girin...",disabled:A,minHeight:"150px"}),(0,a.jsx)("div",{className:"mt-6 flex justify-end",children:(0,a.jsx)(g.default,{onClick:Y,disabled:!d.trim()||A,icon:m.Sparkles,variant:"primary",children:"story"===j?"Yapılandırmayı Başlat":"Simülasyon Oluştur"})})]}),I&&L&&(0,a.jsx)(p,{type:"error",title:"Giriş Hatası",children:I}),A&&(0,a.jsx)("div",{className:"mt-12 animate-fade-in flex flex-col items-center gap-4",children:(0,a.jsx)(T.default,{size:"large",message:D})}),(0,a.jsx)("div",{className:"mt-8 p-4 bg-neutral-50/50 rounded-xl border border-neutral-100/50 text-center",children:(0,a.jsxs)("p",{className:"text-xs text-neutral-400 font-medium italic",children:["🔔 ",c.SAFETY_DISCLAIMER]})})]})}),(0,a.jsx)(z,{user:e})]})});e.s(["default",0,R],75400)},1110,e=>{e.v(e=>Promise.resolve().then(()=>e(11187)))}]);